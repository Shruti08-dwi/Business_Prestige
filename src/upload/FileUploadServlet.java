...
public class FileUploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement pst = con.prepareStatement("insert into hraddform1(id1,firstname,lastname,filename,path) values(?,?,?,?,?)");
            pst.setInt(1, id1);
            ...
            out.println("<center><a href='display.jsp?id1=" + id1 + "'>Display</a></center>");
        } catch (Exception e) {
            out.println(e);
        }
