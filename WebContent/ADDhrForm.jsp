...
<body>
    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-bold text-dark text-center mb-5">Basic
				<span class="font-weight-bold">Form</span>
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="col-lg-6 ">
                        <div class="card">
                            ...
                            <form action="ADDhrForm" method="post">
                           ...
                           <input type="text" placeholder="Contact no" class="form-control" name="cont" >
                           </div>
                 ...
                 <input type="date" placeholder="D.O.B" class="form-control" name="dob">
                 </div>
               ...
               <input type="text"  placeholder="Login id" class="form-control" name="loginid">
               </div>
