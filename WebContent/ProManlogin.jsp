...
<body>
	...
	<div class="login-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-bold text-warning text-center mb-5">Project Manager
				<span class="font-weight-bold">Login</span>
			</h3>
			<!-- content -->
			<div class="sub-main-w3 pt-md-4">
				<form action="PromanDash.jsp" method="post" name="form" onsubmit="return validation()">
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog model-dialog-centered">
      <div class="modal-content">
          ...
          <form action="Forget_passPM" method="post">
