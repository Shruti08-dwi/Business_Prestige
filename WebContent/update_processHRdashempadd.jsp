...
Class.forName("com.mysql.jdbc.Driver");
	...
	PreparedStatement ps = con.prepareStatement("Update hr_empaddform1 set Ename=?,cont=?,salary=?,date=?,dob=?,loginid=?,pass=?,depart=?,team=?,quali=?,desi=?,address=? where id="+id);
