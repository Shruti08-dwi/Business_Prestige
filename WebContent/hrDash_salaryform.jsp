		...
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-bold text-dark text-center mb-5">ADD
				<span class="font-weight-bold">Salary</span>
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="col-lg-6 ">
                        <div class="card">
                            ...
                            <form action="hrDash_salary" method="post">
                   ...
                   <input type="text" placeholder="Days" class="form-control" name="day">
                   </div>
                 ...
                 <input type="text" placeholder="Leave" class="form-control" name="leave">
                 </div>
                 ...
                 <input type="date" placeholder="Month" class="form-control" name="month">
                 </div>
