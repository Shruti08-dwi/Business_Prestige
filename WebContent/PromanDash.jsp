    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="ProMan_Dash1.jsp">ADMIN</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="ProMan_Dash1.jsp"> <i class="menu-icon fa fa-home"></i>Home </a>
                    </li>
                    <li>
                        <a href="PromanDash_ProStatus.jsp"> <i class="menu-icon fa fa-th"></i>Project Status</a>
                    </li>
               </ul>     
            </div><!-- /.navbar-collapse -->
        </nav>
...
Enter Technology:<input type="text" name="ID">
