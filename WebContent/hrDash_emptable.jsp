            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   ...
                   <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="hrDash_emptable.jsp">Form</a></li>
                            <li><i class="fa fa-table"></i><a href="hrDash_emptable.jsp">Display</a></li>
                        </ul>
                    </li>
...
String sql ="select * from hr_empaddform1 where depart='Employees'";
...
<td><%=resultSet.getString("desi") %></td>
<td><%=resultSet.getString("address") %></td>
<td><a href="update_hrDash_empform.jsp?id=<%=resultSet.getString("id")%>" class="btn btn-primary">update</a></td>
