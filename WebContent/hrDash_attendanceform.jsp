    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-bold text-dark text-center mb-5">ADD
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="col-lg-6 ">
                        <div class="card">
                            ...
                            <form action="hrDash_attendance" method="post">
               ...
               <div class="col col-md-3"><label for="team" class="form-control-label">Profile
               </label>
               </div>
               ...
               <option value="Employees">Employees</option>
                       ...
                       <div class="row form-group">
               <div class="col col-md-3"><label for="department" class="form-control-label">P/A
               </label>
               </div>
               <div class="col-12 col-md-9">
               <select name="pal" id="pal" class="form-control">
