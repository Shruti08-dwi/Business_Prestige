...
<head>
	...
	var a = document.form.pswd.value;
	if(a=="")
	{
	...
	document.form.pswd.select();
	return false;
	}
		var a = document.form.number.value;
		if(a=="")
		{
...
<body>
	...
	<div class="login-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-bold text-warning text-center mb-5">Admin
				<span class="font-weight-bold">Login</span>
			</h3>
			<!-- content -->
			<div class="sub-main-w3 pt-md-4">
				<form action="process.jsp" method="post" name="form" onsubmit="return validation()">
					<div class="form-style-agile form-group">
						<label>
							Username
							<i class="fas fa-user"></i>
						</label>
						<input placeholder="Username" class="form-control" name="uname" type="text" required="">
					</div>
					<div class="form-style-agile form-group">
						<label>
							Password
						...
						<input placeholder="Password" class="form-control" name="pswd" type="password" required="">
					</div>
					...
					<div class="form-style-agile form-group">
						...
						<input placeholder="Phone number" class="form-control" name="number" type="text" required="">
					</div>
