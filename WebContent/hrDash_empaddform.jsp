            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="hrDash_attendanceform.jsp">Form</a></li>
                            <li><i class="fa fa-table"></i><a href="hrDash_attendanceDisplay.jsp">Display</a></li>
                        </ul>
                    </li>
                   ...
                   <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="hrDash_salaryform.jsp">Form</a></li>
                            <li><i class="fa fa-table"></i><a href="hrDash_salarydisplay.jsp">Display</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-lg-3">
                      ...
                      <div class="col-lg-6 ">
                        <div class="card">
                            ...
                            <form action="hr_empaddform" method="post">
