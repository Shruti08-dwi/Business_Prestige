	...
	<!-- //banner -->
	 <%
            ...
            try {
                ...
                PreparedStatement st = con.prepareStatement( "SELECT filename FROM image_table where id=1");
	...
	while(set.next())
	{
		...
		%>
				...
				<div class="col-lg-5 agile-course-main-2 mt-4">
					<img src="<%=filename%>" height="600" width="500" alt="" alt="" class="img-fluid">
				</div>
			...
			<div class="row cource-list-agile cource-list-agile-2">
				<div class="col-lg-5 agile-course-main-3 mt-4">
					<img src="<%=filename%>" height="800" width="500" alt="" class="img-fluid img-poiscour mx-auto d-block mt-2"/>
				</div>
...
try
{
	...
	while(set.next())
	{
		...
		%>
				...
				<div class="col-lg-5 agile-course-main-2 mt-4">
					<img src="<%=filename%>" height="800" width="500" alt="" class="img-fluid">
				</div>
				<div class="buttons-w3ls">
					<a class="btn button-cour-w3ls text-white" href="course_details.html" role="button">Learn More</a>
			...
			<div class="row cource-list-agile cource-list-agile-2">
				<div class="col-lg-5 agile-course-main-3 mt-4">
					<img src="<%=filename%>" height="800" width="500" alt="" alt="" class="img-fluid">
				</div>
				<div class="col-lg-7 agile-course-main text-right">
					<div class="w3ls-cource-first">
